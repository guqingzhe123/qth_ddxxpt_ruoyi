...
public class KbsDocumentCommentController extends BaseController {
     ...
     */
    @GetMapping("/list")
    public TableDataInfo<BaseEntity> list(KbsDocumentComment kbsDocumentComment) {
        startPage();
    ...
    public TableDataInfo<BaseEntity> getListByParent(KbsDocumentComment kbsDocumentComment) {
        startPage();
