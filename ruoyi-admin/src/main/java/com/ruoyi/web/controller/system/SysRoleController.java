...
public class SysRoleController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<BaseEntity> list(SysRole role)
    {
        startPage();
    ...
    public TableDataInfo<BaseEntity> allocatedList(SysUser user)
    {
        startPage();
    ...
    public TableDataInfo<BaseEntity> unallocatedList(SysUser user)
    {
        startPage();
