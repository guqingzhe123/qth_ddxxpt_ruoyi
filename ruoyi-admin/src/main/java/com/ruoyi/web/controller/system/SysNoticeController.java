...
public class SysNoticeController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<BaseEntity> list(SysNotice notice)
    {
        startPage();
        notice.setDelFlag("0");
    ...
    public TableDataInfo<BaseEntity> HomeList(SysNotice notice)
    {
        startPage();
    ...
    public TableDataInfo<BaseEntity> userList(SysNotice notice)
    {
        startPage();
