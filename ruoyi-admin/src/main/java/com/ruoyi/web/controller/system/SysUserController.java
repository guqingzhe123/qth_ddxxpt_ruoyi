...
public class SysUserController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<BaseEntity> list(SysUser user)
    {
        startPage();
    ...
    {
        return success(deptService.selectCorpTreeList(dept));
    }
    ...
    public TableDataInfo<BaseEntity> listDeptUser(SysUser user) {
        startPage();
        List<SysUser> list = userService.listDeptUser(user);
        return getDataTable(list);
    }
    ...
    public AjaxResult getUserDetail(@PathVariable(value = "userId") String userId) {
        AjaxResult ajax = AjaxResult.success();
        SysUser sysUser = userService.selectUserById(userId);
        ajax.put(AjaxResult.DATA_TAG, sysUser);
        ajax.put("posts", postService.listUserPost(userId));
        return ajax;
    }
