...
public class MessageNoticeAsyncService implements IAsyncHandler {
    ...
    public void doAsync(AsyncLog asyncLog) {
        ...
        try {
            ...
            //systemMessageService.sendBusinessSystemMessage(BusinessMessageType.TODO_RECEIVE.getCode(), messageNotice.getSenderId(), messageNotice.getRecvIds(), MSG_CONTENT);
        } catch (Exception e) {
