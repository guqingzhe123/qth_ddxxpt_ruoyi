...
//        configuration.setInnerCircle(new SealCircle(2, 85, 45));
        ...
        //1.生成公章
        try {
            SealUtil.buildAndStoreSeal(configuration, "D:\\rad-platform\\公章8.png");
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        SealUtil.buildAndStorePersonSeal(300, 16, font, "印", "D:\\rad-platform\\私章1.png");
    }
...
//        configuration.setInnerCircle(new SealCircle(2, 85, 45));
        ...
        try {
            ...
            SealUtil.buildAndStoreSeal(configuration, "D:\\rad-platform\\公章9.png");
        } catch (IOException e) {
            e.printStackTrace();
        }
