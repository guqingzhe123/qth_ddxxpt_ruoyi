...
import com.ruoyi.im.chat.model.BusinessRecvInfo;
import com.ruoyi.im.chat.model.BusinessSystemMessage;
import com.ruoyi.im.chat.model.ChatSystemMessage;
import com.ruoyi.im.chat.model.ChatUserInfo;
...
public class ChatSender {
    ...
    public Map<String, List<String>> getOnlineToken(List<String> userIds) {
        ...
        for (String id : userIds) {
            List<String> tokenList = redisCacheOther.getCacheList(ChatRedisKey.USER_TOKEN_KEY + id);
    ...
    private Map<String, List<ChatUserInfo>> getServerMap(Object message) {
        ...
        recvIds.forEach(id -> {
            String token = redisCacheOther.getCacheObject(ChatRedisKey.USER_TOKEN_KEY + id);
            //for (String token : tokenList) {
                String key = String.join(":", ChatRedisKey.IM_USER_SERVER_ID, id, token);
