...
public class UserChannelCtxMap {
    ...
    public static Map<String, ChannelHandlerContext> getChannelCtxValue(String userId) {
        return channelMap.get(userId);
    }
    public static Map<String, Map<String, ChannelHandlerContext>> getChannelCtx() {
