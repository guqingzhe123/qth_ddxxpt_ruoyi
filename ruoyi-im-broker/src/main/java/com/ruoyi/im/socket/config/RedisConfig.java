 ...
 * @Author wocurr.com
 */
@Configuration("imSocketRedisConfig")
...
public class RedisConfig {
    ...
    // 重命名 Bean 名称为 "imSocketRedisTemplate"（避免与框架的 "redisTemplate" 冲突）
    @Bean("imSocketRedisTemplate")
    public RedisTemplate<Object, Object> imSocketRedisTemplate(RedisConnectionFactory connectionFactory)
    {
