...
public class FlowMonitorHandleServiceImpl implements IFlowMonitorHandleService {
    ...
    @Override
    public TableDataInfo<BaseEntity> getProcessInstanceList(String procInstId, String businessKey, String name, Integer pageSize, Integer pageNum) {
        TableDataInfo<BaseEntity> rspData = flowMonitorService.getProcessInstanceList(procInstId, businessKey, name, pageSize, pageNum);
    ...
    @Override
    public TableDataInfo<BaseEntity> getHistoryListProcess(String procInstId, String businessKey, String name, Integer pageSize, Integer pageNum) {
        TableDataInfo<BaseEntity> rspData = flowMonitorService.getHistoryListProcess(procInstId, businessKey, name, pageSize, pageNum);
        if (CollectionUtils.isEmpty(rspData.getRows())) {
            return rspData;
        }
        List<FlowInstanceInfoVo> rows = (List<FlowInstanceInfoVo>) rspData.getRows();
    ...
    @Override
    public TableDataInfo<BaseEntity> getHistoryList(String processInstanceId, Integer pageSize, Integer pageNum) {
