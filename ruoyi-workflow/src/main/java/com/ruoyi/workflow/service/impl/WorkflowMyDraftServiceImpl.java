...
public class WorkflowMyDraftServiceImpl implements IWorkflowMyDraftService {
    ...
    @Override
    public int updateHandleTypeByProcInsId(WorkflowMyDraft draft) {
        return workflowMyDraftMapper.updateHandleTypeByProcInsId(draft);
    }
    @Override
    public WorkflowMyDraft updateHandleTypeByProcInsId(String bizId) {
        return workflowMyDraftMapper.queryHandleTypeByBizId(bizId);
    }
