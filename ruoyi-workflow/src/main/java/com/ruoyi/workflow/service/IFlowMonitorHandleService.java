...
public interface IFlowMonitorHandleService {
     ...
     * @return
     */
    TableDataInfo<BaseEntity> getProcessInstanceList(String procInstId, String businessKey, String name, Integer pageSize, Integer pageNum);
     ...
     * @return
     */
    TableDataInfo<BaseEntity> getHistoryListProcess(String procInstId, String businessKey, String name, Integer pageSize, Integer pageNum);
     ...
     * @return
     */
    TableDataInfo<BaseEntity> getHistoryList(String processInstanceId, Integer pageSize, Integer pageNum);
