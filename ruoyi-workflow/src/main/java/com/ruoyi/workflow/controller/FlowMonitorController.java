...
public class FlowMonitorController extends BaseController {
    ...
    @ResponseBody
    public TableDataInfo<BaseEntity> getProcessInstanceList(@RequestParam(required = false) String procInstId,
    ...
    @ResponseBody
    public TableDataInfo<BaseEntity> getHistoryListProcess(@RequestParam(required = false) String procInstId,
                                                           @RequestParam(required = false) String businessKey,
                                                           @RequestParam(required = false) String name,
                                                           @RequestParam Integer pageSize,
                                                           @RequestParam Integer pageNum) {
    ...
    @ResponseBody
    public TableDataInfo<BaseEntity> getHistoryList(@PathVariable String processInstanceId,
                                                    @RequestParam Integer pageSize,
                                                    @RequestParam Integer pageNum) {
        startPage();
