...
public class TodoAsyncService implements IAsyncHandler {
    ...
    public void doAsync(AsyncLog asyncLog) {
        ...
        try {
           ...
           systemMessageService.sendBusinessSystemMessage(BusinessMessageType.TODO_LIST_REFRESH.getCode(), todo.getCurHandler(), Collections.singletonList(todo.getCreateId()), MSG_CONTENT);
        } catch (Exception e) {
